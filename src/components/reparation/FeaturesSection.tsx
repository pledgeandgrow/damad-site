...
const features = [
  {
    ...
    description: 'Identification rapide et précise de la source du problème.'
  },
  {
    icon: <FaCogs className="h-8 w-8 text-white" />,
    title: 'Pièces d\'origine',
    description: 'Utilisation de pièces de rechange certifiées et garanties.'
  },
  {
    icon: <FaShieldAlt className="h-8 w-8 text-white" />,
    title: 'Garantie d\'intervention',
    description: 'Toutes nos réparations sont couvertes par une garantie.'
  },
  {
    icon: <FaClipboardCheck className="h-8 w-8 text-white" />,
    title: 'Suivi technique',
    description: 'Rapport détaillé et conseils pour éviter les pannes futures.'
  }
];
...
export default function FeaturesSection() {
  ...
  return (
    <div id="features" className="py-12 xs:py-16 sm:py-20 bg-white sm:py-24 scroll-mt-16">
      <div className="container mx-auto px-3 xs:px-4 max-w-7xl">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-[#2b3343] max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">
            Notre équipe de techniciens qualifiés intervient rapidement pour diagnostiquer et réparer efficacement tous types de pannes sur vos appareils d&apos;accessibilité.
          </p>
        </div>
