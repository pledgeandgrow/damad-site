      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <p className="text-[#3d4759] mb-6">
            Le site <span className="font-medium text-[#2b3343]">www.damad-ascenseur.com</span> est édité par :
          </p>
          <ul className="space-y-3 mb-8">
            <li className="flex">
              <FaChevronRight className="text-[#2b3343] mt-1 mr-2 flex-shrink-0" />
              <span className="text-[#3d4759]"><span className="font-medium text-[#2b3343]">DAMAD ASCENSEURS</span> - SARL au capital de 50 000 €</span>
            </li>
            <li className="flex">
              <FaChevronRight className="text-[#2b3343] mt-1 mr-2 flex-shrink-0" />
              <span className="text-[#3d4759]">Siège social : 123 Avenue des Ascenseurs, 75001 Paris, France</span>
            </li>
            <li className="flex">
              <FaChevronRight className="text-[#2b3343] mt-1 mr-2 flex-shrink-0" />
            ...
            <li className="flex">
              <FaChevronRight className="text-[#2b3343] mt-1 mr-2 flex-shrink-0" />
              <span className="text-[#3d4759]">N° TVA intracommunautaire : FR 12 123456789</span>
            </li>
            <li className="flex">
              <FaChevronRight className="text-[#2b3343] mt-1 mr-2 flex-shrink-0" />
            ...
            <li className="flex">
              <FaChevronRight className="text-[#2b3343] mt-1 mr-2 flex-shrink-0" />
              <span className="text-[#3d4759]">Email : <Link href="mailto:contact@damad-ascenseur.com" className="text-[#2b3343] hover:text-[#3d4759] hover:underline transition-colors">contact@damad-ascenseur.com</Link></span>
            </li>
          </ul>

          <h2 className="text-2xl font-semibold text-[#2b3343] mb-6">2. Directeur de la publication</h2>
          ...
          <p className="text-[#3d4759] mb-8">
            Pour exercer ces droits, vous pouvez nous contacter à l&apos;adresse email suivante : <Link href="mailto:contact@damad-ascenseur.com" className="text-[#2b3343] hover:text-[#3d4759] hover:underline transition-colors">contact@damad-ascenseur.com</Link> ou par courrier à l&apos;adresse du siège social.
          </p>
          <p className="text-[#3d4759] mb-8">
